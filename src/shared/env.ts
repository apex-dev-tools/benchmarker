...
export function getPuppeteerLaunchOptions(headless?: boolean): PuppeteerNodeLaunchOptions {
	return {
		args: [
...
export function getLighthouseHTMLReport(): boolean {
	return (process.env.LIGHTHOUSE_HTML_REPORT === undefined || process.env.LIGHTHOUSE_HTML_REPORT === 'true');
}
