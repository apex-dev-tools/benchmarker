...
import { Benchmark, BenchmarkResult, ErrorResult } from './base';
import {
  executeAnonymous,
...
// TODO consider an interface instead - to pass a factory instance in
// service method returns a function of request<T..> => run<T..>
