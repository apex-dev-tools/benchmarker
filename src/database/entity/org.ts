...
import { OrgInfoI } from '../../services/orgContext/orgContext';

@Entity({name: 'org_info'})
export class OrgInfo extends PerformanceBaseEntity {

	[key: string]: number | string | Date | boolean | undefined | (() => string) | ((orgInfo: OrgInfoI) => void);
	...
	public fillOrgContextInformation(orgInfo: OrgInfoI) {
